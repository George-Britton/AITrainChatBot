...
def getResp(ucomm):        #Function to be called from UI to get response
    ...
    if counter == 0:
        ...
        if tom_flag:
            ...
            if month_name != 'dummy':
                ...
                trdate = date[:2] + '.' + str(month_number) + '.' + '2021'
        ...
        if tom_flag:
            ...
            if month_name != 'dummy':
                ...
                if month_number < 10:
                    month_number = str(month_number)
                    month_number = '0' + month_number
                rtdate = date[:2] + '.' + str(month_number) + '.' + '2021'
        ...
        ret = (f"You will be travelling from {outFromSta} ({outFromStaAbr}) to {outToSta} ({outToStaAbr}), leaving at {outDepTime}, and arriving at {backFromSta} and returning on {rtdate}. The price will be {costString}")
        booking = False
        counter = 0
        return ret, URL
