...
def SanitizeInput(fromSta, toSta, travelDate, travelTime=1200, arriveDepart=True):
...
def FindTicket(inFromSta, inToSta, inDate, inTime='1200', inArrive=True):
...
# fromStr, fromAbr, toStr, toAbr, depTimeStr, arrTimeStr, costString, URL = FindTicket("norwich", "London", "20022021", "1200", True)
